...
class AccountAssetAsset(models.Model):
    ...
    def compute_depreciation_board(self):
        ...
        if self.depreciation_line_ids:
            last_depr_date = max(
                self.depreciation_line_ids.mapped('depreciation_date'))
        if last_depr_date:
    ...
    def validate(self):
        ...
        for asset in self:
            ...
            lines_to_post_now = draft_lines.filtered(
                lambda l: l.depreciation_date < today_date)
            ...
            future_lines = draft_lines.filtered(
                lambda l: l.depreciation_date >= today_date)
