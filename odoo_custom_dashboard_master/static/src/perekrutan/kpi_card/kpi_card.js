...
export class PerekrutanKpiCard extends Component {
  setup() {
  ...
  async updateKpiData() {
    ...
    try {
      ...
      let lamaranData = await this.orm.call("hr.applicant", "search_read", [
        domain1,
        ["id", "partner_name", "create_date"],
      ]);

      let diterimaData = await this.orm.call("hr.applicant", "search_read", [
        domain2,
        ["id", "partner_name", "create_date"],
      ]);
...
PerekrutanKpiCard.template = "owl.PerekrutanKpiCard";
